Title: Donaty z piekarnika
Date: 2019-08-01
Slug: donuts-from-oven
Summary: Szybkie donaty pieczone w piekarniku.
...
🔹 13 szt. + 1 gniotek </br>
🔹 piekarnik góra-dół, 180 st.C, 14 min </br>

---

#### 🍩 Donaty

&emsp; <input type="checkbox"> 1 szklanka mleka sojowego </br>
&emsp; <input type="checkbox"> 3 łyżki oleju kokosowego (tym razem temperatura w kuchni sprawiła, że w słoiku był płynny) </br>
&emsp; <input type="checkbox"> 1/2 szklanki erytrolu </br>
&emsp; <input type="checkbox"> szczypta soli </br>
&emsp; <input type="checkbox"> łyżeczka cukru trzcinowego </br>
&emsp; <input type="checkbox"> saszetka drożdży instant (8 g) </br>
&emsp; <input type="checkbox"> 3 i 1/2 szklanki mąki pszennej </br>
...
&emsp; <input type="checkbox"> tabliczka czekolady </br>
&emsp; <input type="checkbox"> łyżka oleju rzepakowego </br>
&emsp; <input type="checkbox"> wiórki kokosowe </br>
&emsp; <input type="checkbox"> kolorowa posypka (została mi popiernikowa resztka 😉) </br>
